...
#### Windows
- `rename-by-tmdb-v1.0.6-windows-amd64.zip` - x64系统（推荐）
- `rename-by-tmdb-v1.0.6-windows-arm64.zip` - ARM64系统
- `rename-by-tmdb-v1.0.6-windows-386.zip` - 32位系统

#### macOS
- `rename-by-tmdb-v1.0.6-darwin-amd64.tar.gz` - Intel芯片
- `rename-by-tmdb-v1.0.6-darwin-arm64.tar.gz` - Apple Silicon/M系列芯片

#### Linux
- `rename-by-tmdb-v1.0.6-linux-amd64.tar.gz` - x86_64系统
- `rename-by-tmdb-v1.0.6-linux-arm64.tar.gz` - ARM64系统
